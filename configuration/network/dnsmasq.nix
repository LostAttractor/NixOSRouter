  ...
  services.dnsmasq = {
    ...
    settings = with config.network.interface; {
      ...
      cname = [
        ...
        "qbittorrent.${domain},emby.${domain},jellyfin.${domain},immich.${domain},ipfs.${domain},api.ipfs.${domain},syncthing.${domain},minio.${domain},console.minio.${domain},attic.${domain},nas.${domain}"
        ...
        "authentik.${domain},vaultwarden.${domain},argocd.${domain},hubble.${domain},portainer.${domain},memos.${domain},pdf.${domain},longhorn.${domain},grafana.${domain},uptime.${domain},prometheus.${domain},alertmanager.${domain},loki.${domain},thelounge.${domain},node0-rke.${domain}"
